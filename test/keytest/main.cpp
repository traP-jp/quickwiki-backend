...
int main() {
    ...
    int num_keywords = 5;
    DataArray dataList = extract(text.c_str(), num_keywords);

    for (size_t i = 0; i < dataList.size; i++) {
        std::cout << dataList.tag_names[i] << ": " << dataList.scores[i] << std::endl;
    }
    ...
    int num_keywords2 = 5;
    DataArray dataList2 = extract(text2.c_str(), num_keywords2);

    for (size_t i = 0; i < dataList2.size; i++) {
        std::cout << dataList2.tag_names[i] << ": " << dataList2.scores[i] << std::endl;
    }
